...
export const DataMemoryCard = [
    {name: 'meliodas', id: 1, img: require('../../assets/games/meliodas.webp')},
    {name: 'ban', id: 2, img: require('../../assets/games/ban.png')},
    {name: 'elaine', id: 3},
    {name: 'king', id: 4, img: require('../../assets/games/king.png')},
    {name: 'diane', id: 5},
    {name: 'merlin', id: 6},
];